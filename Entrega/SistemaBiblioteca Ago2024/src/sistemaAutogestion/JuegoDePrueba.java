...
public class JuegoDePrueba {
    ...
    public static void juegoDePrueba(Sistema sis){
        ...
        Estudiante estudiante = sis.Estudiantes.obtenerElemento(e3);
        estudiante.agregarPrestamo(libro);
        System.out.println("Intentar eliminar estudiante con préstamo activo: " + sis.eliminarEstudiante(4444).resultado);
    }
}
