...
public class BIBLIOTECAMAIN {
    ...
    public static void juegodeprueba(Sistema s, Prueba p) {
        ...
        p.ver(s.prestarLibro(null, 1).resultado, Retorno.Resultado.ERROR_1, "Error 1 Isbn vacio");
        ...
        System.out.println("Libros deshacer eliminación "+s.listarLibros().valorString + "\n");
